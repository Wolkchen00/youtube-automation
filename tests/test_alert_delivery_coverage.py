...
def test_only_explicit_presentation_sites_may_call_markdown_send_message():
    ...
    expected_plain_routes = {
        "approver.py": 2,
        "critic.py": 1,
        # Anlatim kirpma alarmi ucunculeyi ekledi: anlatim videoya sigmadi
        # ve sonu kesildi, bolum butunlugu kusurlu sayiliyor.
        "produce.py": 3,
        "replenish.py": 1,
        ...
        # ROCK E (kalici bolum eseri) altincisini ekledi: kalici eser
